...
//
// Modbus TCP is hand-rolled on top of WiFiClient (see the section
// below) - the official ArduinoModbus/ArduinoRS485 libraries only
// target SAMD/megaAVR/mbed boards and fail to build for ESP32.
//
